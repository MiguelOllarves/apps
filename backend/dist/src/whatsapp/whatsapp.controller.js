...
let WhatsappController = class WhatsappController {
    ...
    async previewDailySummary(tenantId) {
        return this.whatsappService.generateDailySummary(tenantId);
    }
};
exports.WhatsappController = WhatsappController;
__decorate([
    (0, common_1.Post)('daily-summary'),
    __param(0, (0, common_1.Headers)('x-tenant-id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WhatsappController.prototype, "sendDailySummary", null);
__decorate([
    (0, common_1.Get)('daily-summary/preview'),
    __param(0, (0, common_1.Headers)('x-tenant-id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WhatsappController.prototype, "previewDailySummary", null);
